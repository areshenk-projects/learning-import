#' Organize MRL1 data after import
#'
#' Function accepts a list returned by ImportTaskMRL1 and returns a
#' dataframe of subject task data
#'
#' @param json A list returned by ImportTaskMRL1
#' @return A dataframe
#'
#' @export

OrganizeTaskMRL1 <- function(data) {
